...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus'), 'Cleaner')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Save'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/i_Job_oxd-icon bi-caret-down-fill oxd-userd_f084ee'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Logout'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_OrangeHRM/img'), '')
