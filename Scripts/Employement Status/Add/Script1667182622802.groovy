...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Employment Status'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/button_Add'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Name_oxd-input oxd-input--focus'), 'Contract')
